...
>
  ...
  <div className='flex items-center gap-5 p-3 '>
    ...
    <form onSubmit={(e)=>{
      ...
      }} className=' font-mono bg-[#eee] px-6 py-4 text-base rounded-lg w-full mt-3' type="text" placeholder='Enter Otp' />
    <Link to='/captain-riding' className='w-full  text-lg flex justify-center mt-5 bg-green-500 text-white font-semibold p-3 rounded-lg'>Confirm</Link>
    <button onClick={()=>{
